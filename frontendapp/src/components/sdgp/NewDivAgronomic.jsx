...
export default function NewDivAgronomic({ setPage }) {
  const API_BASE_URL = "https://api.smartteamonitor.com/api/agronomic-data";
                ...
                currentRows.map((item, index) => (
                  <tr key={item.id || index}>
                    ...
                    <td className="new-agro-action-cell" onMouseLeave={() => setOpenMenuId(null)}>
                      ...
                      {openMenuId === item.id && (
                        <div className="new-agro-action-dropdown">
                          <button onClick={() => handleUpdate(item)}>✎ Update</button>
                          <button className="new-agro-delete-btn" onClick={() => handleDelete(item.id)}>🗑 Delete</button>
                        </div>
                      )}
                    </td>
                  </tr>
        ...
        <div className="new-agro-modal-overlay">
          <div className="new-agro-modal-content new-agro-modal">
            ...
            <form className="new-agro-grid-form" onSubmit={handleSubmit}>
              ...
              <div className="new-agro-form-group">
                <label>Date</label>
                <input 
                  type="date" 
                  name="date" 
              ...
              <div className="new-agro-form-group new-agro-full-width">
